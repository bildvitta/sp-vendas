...
use BildVitta\SpVendas\Console\Commands\Messages\Resources\SaleMessageProcessor;
use Exception;
...
class SaleWorkerCommand extends Command
{
    /**
    ...
    /**
     * @var SaleMessageProcessor
     */
    private SaleMessageProcessor $saleMessageProcessor;

    /**
     * @param SaleMessageProcessor $saleMessageProcessor
     */
    public function __construct(SaleMessageProcessor $saleMessageProcessor)
    {
        parent::__construct();
        $this->saleMessageProcessor = $saleMessageProcessor;
    }
    ...
    private function process(): void
    {
        ...
        $callback = [$this->saleMessageProcessor, 'process'];
